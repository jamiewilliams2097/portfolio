...
export const selectedEdits: SelectedEdit[] = [
  {
    slug: 'main-showreel',
    title: 'Main Showreel',
    client: 'Jamie Williams',
    editingNote:
      'A broad editing reel showing commercial, presenter-led, brand and creator work cut for pace, clarity and variety.',
    whyThisCutWorks: [
      'Shows range quickly',
      'Opens with strong visual variety',
      'Keeps the reel moving without losing clarity',
    ],
    tags: ['Showreel', 'Pacing', 'Commercial'],
    vimeoId: '1198580530',
    thumbnail: '/thumbnails/main-showreel.png',
    mediaAspect: '16 / 9',
    clipId: '01_MAIN_SHOWREEL',
    duration: '00:01:30:00',
    paceProfile: '',
    paceLabel: '',
  },
  {
    slug: 'sports-showreel',
    title: 'Sports Showreel',
    client: 'Jamie Williams',
    editingNote:
      'A focused sports reel built around energy, atmosphere, tension and impact.',
    whyThisCutWorks: [
      'Leads with movement and intensity',
      'Uses rhythm to build momentum',
      'Shows sports editing range quickly',
    ],
    tags: ['Sports', 'Pacing', 'Sound polish'],
    vimeoId: '1198580531',
    thumbnail: '/thumbnails/sports-showreel.png',
    mediaAspect: '16 / 9',
    clipId: '02_SPORTS_SHOWREEL',
